-- COMPLETE ADMIN SETUP - Copy ALL of this to phpMyAdmin
-- This will add the missing column AND create the admin users
...
-- Step 4: Create admin user with correct password hash for 'secret'
INSERT INTO users (name, email, password, account_role, phone, trust_pref, created_at) 
VALUES (
...
-- Step 5: Create vendor user with correct password hash for 'secret'
INSERT INTO users (name, email, password, account_role, phone, trust_pref, created_at) 
VALUES (
    'Test Vendor', 
    'vendor@gulio.com', 
...
-- Step 7: Show all users to verify
SELECT id, name, email, account_role FROM users ORDER BY account_role, id;
